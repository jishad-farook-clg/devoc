    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex-1 container mx-auto px-4 py-12 flex items-center justify-center">
        <div className="w-full max-w-2xl">
          {!success ? (
            <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-slate-100 relative animate-fade-up">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 my-6">
                ...
                <ol className="space-y-2 text-sm text-secondary/80 list-decimal list-inside pl-1">
                  ...
                  <li>
                    Copy the full URL from your
                    browser&apos;s address bar.
                  </li>

                  <li>
                    Paste that link into the field
                    below.
                  </li>
                </ol>
              </div>
              ...
              >
                ...
                <button
                  disabled={loading}
                  className="
                    w-full py-4 bg-primary hover:bg-secondary
            ...
            /* Success State */
            <div className="bg-white p-10 rounded-3xl shadow-xl text-center border border-slate-100 animate-scale-in">
              ...
              <p className="text-slate-600 mb-8 text-lg">
                Great job! Your CodePen link has been
