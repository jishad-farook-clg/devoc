...
// Cleaned up Data - Removed inline styles, kept pure data
  ...
  return (
    <section className="py-20 md:py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <Link
          href="/events"
          className="group hidden md:flex items-center gap-2 text-sm font-bold
            text-blue-600 bg-blue-50
            px-4 py-2 rounded-full border border-blue-200
            transition-all duration-300 ease-out
            hover:text-blue-700 hover:bg-blue-100 hover:border-blue-300"
        >
          View Archive
          <ArrowUpRight
            size={16}
        ...
        >
          {events.map((event) => (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }} // Tactile feedback on touch
              className="
