...
export default function AboutSecond() {
  return (
    <section
      id="about"
      className="py-20 px-10 lg:py-32 bg-white relative overflow-hidden"
    >
          ...
          >
            <div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                We believe that financial constraints
                shouldn&apos;t stop talent from blooming.
                DeVoc provides a structured,
                mentorship-driven hybrid learning
                environment where you don&apos;t just
                watch videos—you build, collaborate,
                and deploy real software.
              </p>
              ...
              <div className="inline-block active:scale-95 transition-transform">
                <Link
                  href="/contact"
          ...
          >
            <>
              {[
                ...
                <div
                  key={idx}
                  className={`p-6 rounded-2xl bg-white border border-slate-100 shadow-xl shadow-slate-200/50 flex flex-col items-center text-center hover:-translate-y-1 transition-transform duration-300 ${
                    idx === 1 || idx === 3
                      ? "translate-y-8"
                      : ""
                  }`}
                >
                  <div
                    className={`p-3 rounded-full mb-4 ${section.bg} ${section.color}`}
                  >
