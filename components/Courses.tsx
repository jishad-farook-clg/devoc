  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        ...
        {/* Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-8 md:pb-0">
          {courses.map((course: any, idx: number) => (
            ...
            >
              <div
                ...
                className="group cursor-pointer bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-sm w-full flex flex-col hover:shadow-md transition-all duration-300 active:scale-[0.98]"
              >
